...
class SyncTaskTypeVersion extends ApiModel
{
	...
	protected static $storeRules = [
		'sync_task_type_id'     => 'required|string|max:50|exists:sync_task_type,id|unique_with:sync_task_type_v,i18n_lang_id',
	...
	protected static $patchRules = [
		'sync_task_type_id'     => 'string|max:50|exists:sync_task_type,id', // Custom composite key validation in controller method to manage "ignore" parameter.
	...
	protected static $putRules = [
		'sync_task_type_id'     => 'required|string|max:50|exists:sync_task_type,id', // Custom composite key validation in controller method to manage "ignore" parameter.
		'i18n_lang_id'          => 'required|string|max:30|exists:i18n_lang,id',
		'description'           => 'required|string'
	];
