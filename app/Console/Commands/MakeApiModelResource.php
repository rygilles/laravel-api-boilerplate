...
class MakeApiModelResource extends Command
{
        ...
        if ($makePrimaryId) {
            ...
            if ($primaryKeyType == 'string') {
                ...
                while (is_null($primaryKeyStringLength)) {
                    ...
                    if (! is_int($primaryKeyStringLength)) {
     ...
     * @return bool Return false if file not found or not editable
     */
     ...
     * @param bool $makeIndexRoute
     * @param bool $makeShowRoute
     * @param bool $makeStoreRoute
     * @param bool $makeUpdateRoutes
     * @param bool $makeDestroyRoute
     * @return bool Return false if file not found or not editable
     */
