...
class MakeApiModelResourceAssets extends Command
{
     ...
     * @param $data
     * @return bool Return false value already in file
     */
     ...
     * @param string $filePath file path
     * @param string[] $data
     * @return bool Return false if regex failed or already value already in file
     */
     ...
     * @param string $filePath file path
     * @param string[] $data
     * @return bool Return false if value already in file
     */
    ...
    protected function alterSideBarMenuVueFile($filePath, $data)
    {
        ...
        /** @var int $fileLineInc Increment lines array of this amount */
        $fileLineInc = 0;
